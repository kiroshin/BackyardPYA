...
if __name__ == '__main__':
    ...
    app = QApplication()
    window = MockWindow()
    profile1 = CircleImgLabel(80, parent=window)
    profile2 = CircleImgLabel(80, "../assets/portraits_women_44.jpg", parent=window)
    window.central_widget_layout.addWidget(profile1, 0, Qt.AlignmentFlag.AlignCenter)
    window.central_widget_layout.addWidget(profile2, 0, Qt.AlignmentFlag.AlignCenter)
    window.show()
    app.exec()
